"""
SteadyCom implementation from reframed, 
modified by Andrea Stallvik to add possibility to specify own objective function om SteadyCom and SteadyComVA.
"""
...
def SteadyCom(community, constraints=None, solver=None, objective=None):
...
def SteadyComVA(community, obj_frac=1.0, constraints=None, solver=None, objective = None):
