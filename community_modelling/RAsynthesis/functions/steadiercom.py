"""
An updated version of reframed.community.simulate.py, extending steadiercom to include variance analysis.
Using the same FVA implementation as reframed.community.SteadyCom

Modified from reframed by Andrea Stallvik, on 13.10.23.
"""

from reframed.core.model import ReactionType
from reframed.solvers import solver_instance
from math import inf, isinf
from reframed.community.solution import CommunitySolution
...
def build_problem(community, growth=0.1, abundance=None):
    ...
    # update growth func. added from reframed.comunity.SteadyCom
...
def SteadierComFVA(community, objective=None, growth=0.1, abundance=None, allocation=False, constraints=None,
    ...
    # --- changes to simulate in order to return FVA result follow below ---
...
def binary_search(solver, objective, obj_frac=1, minimize=False, max_iters=20, abs_tol=1e-3, constraints=None):
    ...
    """Function taken from reframed.community.SteadyCom."""
